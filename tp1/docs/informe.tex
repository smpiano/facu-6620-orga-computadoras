...
Esta función invoca a \textit{strcasecmp} como a \textit{data_swaper}.

\FloatBarrier

Esta función fue implementada como leaf, sin invocar otras funciones
auxiliares. Se reservan 8 bytes para salvar gp y fp. No es necesario reservar espacio adicional para ABA.
